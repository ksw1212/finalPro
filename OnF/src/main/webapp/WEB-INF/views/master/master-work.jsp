				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						<li class="sidebar-item"><a class="sidebar-link sidebar-link"
							href="mydept.jsp" aria-expanded="false"><i
								data-feather="home" class="feather-icon"></i><span
								class="hide-menu">Dashboard</span></a></li>
						<li class="list-divider"></li>
						<li class="nav-small-cap"><strong style="font-weight: 800"
							class="hide-menu">직원 관리</strong></li>

						<li class="sidebar-item"><a class="sidebar-link"
							href="master-emp.jsp" aria-expanded="false"> <i
								data-feather="tag" class="feather-icon"></i> <span
								class="hide-menu"> 직원 목록 </span>
						</a></li>
						<li class="sidebar-item"><a class="sidebar-link sidebar-link"
							href="#" aria-expanded="false"> <i
								data-feather="message-square" class="feather-icon"></i> <span
								class="hide-menu">퇴사자 관리</span></a></li>
						<li class="list-divider"></li>
						<li class="nav-small-cap"><strong style="font-weight: 800"
							class="hide-menu">휴가 관리</strong></li>

						<li class="sidebar-item"><a class="sidebar-link" href="${root}master/vaq_approve"
							aria-expanded="false"> <i data-feather="tag"
								class="feather-icon"></i> <span class="hide-menu"> 휴가 목록
							</span>
						</a></li>
						<li class="list-divider"></li>
						<li class="nav-small-cap"><strong style="font-weight: 800"
							class="hide-menu">부서 관리</strong></li>
						<li class="sidebar-item"><a class="sidebar-link" href="#"
							aria-expanded="false"> <i data-feather="tag"
								class="feather-icon"></i> <span class="hide-menu"> 부서 목록
							</span>
						</a></li>
						<li class="list-divider"></li>
						<li class="nav-small-cap"><strong style="font-weight: 800"
							class="hide-menu">근태 관리</strong></li>
						<li class="sidebar-item"><a class="sidebar-link" href="${root }master/master-worktype"
							aria-expanded="false"> <i data-feather="tag"
								class="feather-icon"></i> <span class="hide-menu"> 근무 유형
									목록 </span>
						</a> <a class="sidebar-link" href="#" aria-expanded="false"> <i
								data-feather="tag" class="feather-icon"></i> <span
								class="hide-menu"> 직원 근태 현황 </span>
						</a></li>
						<li class="list-divider"></li>

						<li class="nav-small-cap"><span class="hide-menu">회사
								설정</span></li>
						<li class="sidebar-item"><a class="sidebar-link sidebar-link"
							href="${root }master/companySetting" aria-expanded="false"> <i class="icon-action-redo"></i>
								<span class="hide-menu">마스터 변경</span>
						</a></li>
						<li class="sidebar-item"><a class="sidebar-link sidebar-link"
							href="${root }master/companyDelete" aria-expanded="false"> <i class="fas fa-trash-alt"></i>

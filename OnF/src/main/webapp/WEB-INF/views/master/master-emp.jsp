			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-6 align-self-center">
						<h3 class="page-title text-truncate text-dark font-weight-medium mb-1">직원목록 보기</h3>
					...
					<div class="col-3">
						<div class=" customize-input float-right">
								...
								<div class="modal-dialog modal-dialog-centered">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="myCenterModalLabel"><i class="icon-user-follow"></i>&nbsp;&nbsp;&nbsp;직원정보 등록 </h4>
											...
											<div class="col-12 col-6 col-4">
												<form>
													<div class="col-12 form-group mb-4">
														<h6 style="font-weight: 800">개인정보 입력</h6>
														<span>이&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;름&nbsp;&nbsp;&nbsp;&nbsp;<input
															type="text" placeholder="이름 입력" /></span>
													</div>
													<div class="col-12 form-group mb-4">
														<span>이&nbsp;&nbsp;&nbsp;&nbsp;메&nbsp;&nbsp;&nbsp;&nbsp;일&nbsp;&nbsp;&nbsp;&nbsp;<input
															type="text" placeholder="이름 입력" /></span>
													...
													<p></p>
													<div class="col-12 form-group mb-4">
														<h6 style="font-weight: 800">인사정보 입력</h6>
														<span>소속부서&nbsp;&nbsp;&nbsp;&nbsp; <select
													...
													<div class="col-12 form-group mb-4">
														<span>근무유형&nbsp;&nbsp;&nbsp;&nbsp; <select
															class="col-8 custom-select" id="inlineFormCustomSelect">
																<option value="1">정규-일반</option>
																<option value="2">정규-야간</option>
														</select>
														</span>
													</div>
													<div class="col-12 form-group mb-4">
													...
													<button type="button"
														...
														data-toggle="modal" data-target="#centermodal" style="float: right;">확인</button>
												</form>
											</div>
										</div>
									</div>
							...
							<div class="btn-list">
								...
								<button type="button"
									class="btn waves-effect waves-light btn-rounded btn-primary"
									data-toggle="modal" data-target="#centermodal1"> 직원정보 입력</button>
								<button type="button" 
									class="btn waves-effect waves-light btn-rounded btn-outline-danger" 
									data-toggle="modal" data-target="#centermodal2" > 직원정보 삭제</button>
							</div>
						</div>
					</div>
				</div>
									...
									<table class="table table-hover">
										...
										<tbody style="text-align:center">
											<tr >
												...
												<td data-toggle="modal" data-target="#scrollable-modal">팀장</td>

				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li class="sidebar-item"><a class="sidebar-link"
							href="${root }master/master-emp" aria-expanded="false"> <i
						...
						<li class="sidebar-item"><a class="sidebar-link" href="${root }vac_approve"
						...
						<li class="nav-small-cap"><span class="hide-menu">회사
								설정</span></li>
						<li class="sidebar-item"><a class="sidebar-link sidebar-link"
							href="#" aria-expanded="false"> <i class="icon-action-redo"></i>
								<span class="hide-menu">마스터 변경</span>
						</a></li>
						<li class="sidebar-item"><a class="sidebar-link sidebar-link"
							href="#" aria-expanded="false"> <i class="fas fa-trash-alt"></i>
